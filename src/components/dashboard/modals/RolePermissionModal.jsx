  ...
  return (
    <ModalShell title="System Hierarchy & Access" onClose={onClose}>
      <div className="grid gap-8 md:grid-cols-2">
        <form
          className="space-y-6 rounded-[24px] border border-neutral-100 bg-neutral-50/20 p-6 relative overflow-hidden group"
          onSubmit={submitRole}
        >
            ...
            <div className="space-y-2">
              ...
              <div className="max-h-32 space-y-2 overflow-auto rounded-xl border border-neutral-100 bg-white p-3 shadow-inner">
                {permissions.map((permission) => (
                  <label
                    key={permission.id}
                    className="flex items-center gap-3 text-[11px] font-bold text-neutral-600 group cursor-pointer hover:text-primary transition-colors"
                  >
                    <input
                      type="checkbox"
