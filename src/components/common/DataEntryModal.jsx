...
const DataEntryModal = ({ type, onClose, onSave }) => {
  const configs = {
    department: {
      ...
      fields: [
        { id: 'name', label: 'Department Name *', placeholder: 'e.g. Spirits, Wine' },
        { id: 'localizedName', label: 'Localized Name', placeholder: 'Display name' }
      ]
    },
    brand: {
      ...
      fields: [
        ...
        { id: 'manufacturer', label: 'Manufacturer', placeholder: 'Parent company' }
      ]
    },
    category: {
      ...
      fields: [
        ...
        { id: 'localizedName', label: 'Localized Name', placeholder: 'Display name' },
        { id: 'department', label: 'Parent Department', placeholder: 'Select Department', type: 'select', options: ['Liquor', 'Beer', 'Wine', 'Tobacco'] }
      ]
    },
    subCategory: {
      title: 'Sub-Category Data',
      fields: [
        { id: 'name', label: 'Sub-Category Name *', placeholder: 'e.g. Single Malt' },
        { id: 'localizedName', label: 'Localized Name', placeholder: 'Display name' },
        { id: 'category', label: 'Parent Category', placeholder: 'Select Category', type: 'select', options: ['Scotch', 'Irish', 'Japanese'] }
      ]
    },
    size: {
      ...
      fields: [
        ...
        { id: 'localizedName', label: 'Localized Name', placeholder: 'Display name' },
        { id: 'category', label: 'Default Category', placeholder: 'Select Category', type: 'select', options: ['Spirits', 'Wine'] },
        { id: 'uom', label: 'Unit of Measure', placeholder: 'Select UOM', type: 'select', options: ['ML', 'L', 'OZ', 'GL'] }
      ]
    },
    pack: {
              ...
              <div key={field.id} className="relative group">
                {field.type === 'select' ? (
                  ...
                  <div className="relative">
                    ...
                    />
                    <label className="absolute top-1/2 left-5 -translate-y-1/2 text-neutral-400 text-sm font-bold transition-all pointer-events-none 
