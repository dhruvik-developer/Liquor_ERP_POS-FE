        ...
        <div className="lg:col-span-4 space-y-6">
          <Card className="flex flex-col items-center py-10">
            ...
            <div className="mt-6 text-center">
              <h2 className="text-[20px] font-black text-[#1E293B] tracking-tight">Admin User</h2>
              <p className="text-[12px] font-bold text-[#0EA5E9] uppercase tracking-widest mt-1">System Administrator</p>
            </div>
            ...
            <div className="mt-8 pt-8 border-t border-[#E2E8F0] w-full space-y-4">
               <div className="flex justify-between items-center text-[13px]">
                  ...
                  <span className="text-[#1E293B] font-bold">OP-4829</span>
               </div>
               <div className="flex justify-between items-center text-[13px]">
                  <span className="text-[#64748B] font-medium">Last Access</span>
                  <span className="text-[#1E293B] font-bold">18-Mar-2026</span>
               </div>
               <div className="flex justify-between items-center text-[13px]">
        ...
        <div className="lg:col-span-8 space-y-8">
          <Card title="Basic Information">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-4">
              <Input label="Full Name" defaultValue="Admin User" icon={User} />
              <Input label="Email Address" defaultValue="admin@liquorpos.com" icon={Mail} />
